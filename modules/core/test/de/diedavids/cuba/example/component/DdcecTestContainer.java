package de.diedavids.cuba.example.component;
...
public class DdcecTestContainer extends TestContainer {

    public DdcecTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/diedavids/cuba/example/component/app.properties",
    ...
    public static class Common extends DdcecTestContainer {

        public static final DdcecTestContainer.Common INSTANCE = new DdcecTestContainer.Common();
